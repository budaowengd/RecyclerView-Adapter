...
//        mAdapter=new Frag2Adapter(getContext(),R.layout.item_text2,mDatas);
//        mRecyclerView.setAdapter(mAdapter);
//    }

//    class Frag2Adapter extends SimpleAdapter<ModelData> {
//
//        public Frag2Adapter(Context context, int layoutId, List<ModelData> datas) {
